...
from utils.fftc import ifft2_2c, fft2_2c
from utils.mri_transforms import complex_multiplication, conjugate
...
if __name__ == "__main__":
    model = Unet2d(num_filters=32, num_pool_layers=4, dropout_probability=0.0, skip_connection=True, normalized=False)
    # model_structure(model)

    # from thop import profile
    # input1 = torch.randn(1, 640, 368, 2)
    # input2 = torch.randn(1, 12, 640, 368, 2)
    # input3 = torch.randn(1, 1, 640, 368, 1)
    # input4 = torch.randn(1, 12, 640, 368, 2)
    #
    # flops, params = profile(model, (input1, input2, input3, input4))
